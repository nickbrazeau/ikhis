...
| A. Governance | Final protocol | implemented for initial release | Operational v0.1.0 written; no claim of external preregistration or human approval. |
...
| D. Corpus construction | family/entity-specific searches | partial coverage / implementation | 29 protein-symbol PubMed queries plus four lanes; ten relevance-ranked IDs each; original aliases retained in mapping. |
...
| D. Corpus construction | frozen initial corpus | implemented for initial release | 27 included source records / 26 publication families; 72 assertions; explicitly bounded. |
...
| I. Release | integrated multi-omic paths | pending scientific completion | Empty by design: eight candidate joins fail context/bridge checks; complete source-backed path extraction remains. |
...
| I. Release | prior tables | partial coverage / implementation | All ten parameter families exported; unsupported numeric families explicitly unavailable. |
...
| I. Release | freeze/hash Release 0.1 | implemented for initial release | Local initial release hash manifest; verify after rebuilding. Whole-review completion not claimed. |
